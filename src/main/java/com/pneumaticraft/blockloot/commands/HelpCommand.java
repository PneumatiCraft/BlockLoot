...
public class HelpCommand extends BlockLootCommand {
    private static final int CMDS_PER_PAGE = 7;

    public HelpCommand(BlockLoot plugin) {
        super(plugin);
        this.setName("Get Help with Block Loot");
        this.setCommandUsage("/bl " + ChatColor.GOLD + "[FILTER] [PAGE #]");
        this.setArgRange(0, 2);
        this.addKey("bl");
        this.addKey("blh");
        this.addKey("blhelp");
        this.addKey("bl help");
        this.addKey("blsearch");
        this.addKey("bl search");
        this.setPermission("blockloot.help", "Displays a nice help menu.", PermissionDefault.TRUE);
    }

    @Override
    public void runCommand(CommandSender sender, List<String> args) {
        sender.sendMessage(ChatColor.AQUA + "====[ Block Loot Help ]====");
